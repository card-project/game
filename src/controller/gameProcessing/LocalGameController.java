...
public class LocalGameController extends GameController {
	...
	/**
	 * The complete sequence to be executed by a {@link Player} but without
	...
	public void playCard( Card card, Player target ) {
		...
		try {
			...
			replay = e.getSafety().playCoupFourre( e.getCoupFourreInitiator(), this.game.getCurrentPlayer(),
					e.getHazardCardInitiator(), this.game.getGoal() );
