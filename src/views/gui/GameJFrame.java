...
public class GameJFrame extends JFrame {
	...
	private DisplayMode originalMode = null; // We do a back-up to keep in
												// memory the original mode of
												// the screen
	...
	public void displayWindow() {
		...
		if ( isFullScreen ) {
			...
			this.setSize( this.getScreenInformations().getDisplayMode().getWidth(), this.getScreenInformations()
