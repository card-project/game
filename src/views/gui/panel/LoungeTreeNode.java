...
/**
 * This class represents a node for the tree. We use this class to display the sever's list.
 */
public class LoungeTreeNode extends DefaultMutableTreeNode {
	...
	/**
	 * The lounge adress is valid for a certain time. After a while, we delete this lounge's adress.
	 * We return false if this lounge isn't valid.
	 * @return boolean
	 */
