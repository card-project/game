...
public interface Strategy {
	...
	/**
	 * Determine which stack the {@link AIPlayer} draws on. The choice depends
	...
	/**
	 * Determine which card to pick in {@link AIPlayer}'s {@link HandStack}. The
	 * choice depends on the implemented algorithm.
	 * 
