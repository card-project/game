 ...
 * AI player strategy.
 * 
 * Draw a safety/remedy as soon as possible. Play a safety/remedy as soon as
 * possible. Discard duplicate remedy and hazard.
 * 
...
public class Protector extends Behavior {
	...
	/**
	 * Priorities : 1 - GoRoll if not started 2 - Correspondent remedy/safety if
	 * attacked 3 - New remedy
	 * 
	...
	/**
	 * Priorities : 1 : player is attacked, play the correspondent remedy/safety
	...
	/**
	 * Priorities : 1 : Remedy having the same family than a played safety. 2 :
	 * Duplicate remedy. 3 : 1st remedy in player's hand (~Random). Finally
	 * check whether the discarded helps an opponent.
	 * 
