...
/**
 * Create a remedy card object. Allow a player to defend himself from another
 * player attack once this one is on the {@link BattleStack}.
 * 
...
public class RemedyCard extends Card implements Serializable {
	...
	/**
	 * Play the current {@link RemedyCard} on the chosen {@link Player} and take
	 * it off from his hand. Determine also whether this move implies the player
	 * to replay.
	 * 
	 * @param p
	 *            {@link Player} who plays the {@link RemedyCard}.
