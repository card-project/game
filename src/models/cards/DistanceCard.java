...
public class DistanceCard extends Card implements Serializable {
	...
	/**
	 * Build a new {@link DistanceCard} object depending on its {@link CardType}
	 * parameter.
	 * 
	 * @param type
	 *            {@link CardType} setting the {@link DistanceCard} range value.
	 */
	...
	/**
	 * Whether the current {@link DistanceCard} is playable on the chosen
	 * target.
	 * 
	 * @param p
	...
	/**
	 * Play the current {@link DistanceCard} on the chosen {@link Player} and
	 * take it off from his hand. Determine also whether this move implies the
	 * player to replay.
	 * 
	 * @param args
	 *            {@link Player} who plays the {@link DistanceCard}.
	...
	/**
	 * Define the correct range value depending on its {@link CardType}
	 * attribute.
	 * 
