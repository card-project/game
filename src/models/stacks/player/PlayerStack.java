...
/**
 * Structure containing {@link Card} objects belonging to a {@link Player}. This
 * {@link Player} knows the whole content of the {@link PlayerStack}.
 * 
...
public abstract class PlayerStack extends CardsStack implements Serializable {
	...
	/**
	 * Check whether a {@link Card} having the {@link CardType} exists in the
	 * current {@link PlayerStack}.
	 * 
	 * @param ct
	 *            {@link CardType} to search.
	...
	/**
	 * Shift a {@link Card} from the current {@link PlayerStack} to the
